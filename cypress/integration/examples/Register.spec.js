...
describe('Daraz-Website Automation', function () {
    ...
    before(function () {
        ...
        // User LOGIN
        cy.get(LOGIN).click()
        cy.get(Enter_Email).type('joshireetik2017@gmail.com').wait(1000)
        cy.get(Enter_password).type('reetik12345').wait(1000)
    ...
    it('Visits the seller homepage (Oliz Homepage) in Daraz.', function () {
        ...
        cy.visit(Oliz_HomePage_url).title().should('contain.text', 'Oliz Store Nepal: Official Online Store - Daraz.com.np').wait(500);
    })
    ...
    it('Clicks Shop Now -> Verify Free Delivery in Product page', function () {
        ...
        //* Commented following assertion since delivery charge text is not 'Free' sometimes
